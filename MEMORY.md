...
**【强制】所有 App 图标必须满足以下所有条件：**

1. **✅ 必须是 3D**：禁止扁平图标，必须有立体感、渐变、高光、阴影
2. **✅ 必须有辉光/光晕效果**：glowing, halo, 高光边缘
3. **✅ 必须有 premium feel**：渐变、3D 质感、材质感，禁止廉价感
4. **✅ 暖色/活力优先**：生产类 App 用暖色调（绿/橙/红），增加能量感
5. **✅ 吸引眼球**：让人一看就想下载，有冲击力
6. **✅ 圆角外必须透明**：四角必须是 alpha=0 透明，不能是白色
7. **✅ 不侵权**：图标元素必须原创或已获授权，禁止抄袭他人设计
...
8. **透明角落** — iOS App Store 图标圆角外的四角必须是 alpha=0 透明
